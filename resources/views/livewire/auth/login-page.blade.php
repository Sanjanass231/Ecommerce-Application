        ...
        <div class="p-4 sm:p-7">
          ...
          <form wire:submit.prevent="save">
            ...
            <div class="grid gap-y-4">
              <!-- Form Group -->
              <div>
                <label for="email" wire:model="email" class="block text-sm mb-2 dark:text-white">Email address</label>
                <div class="relative">
              ...
              <div>
                <div class="flex justify-between items-center">
                  <label for="password" wire:model="password" class="block text-sm mb-2 dark:text-white">Password</label>
