		...
		<div class="md:col-span-12 lg:col-span-8 col-span-12">
			...
			<div class="bg-white rounded-xl shadow p-4 sm:p-7 dark:bg-slate-900">
				...
				<div class="mb-6">
					...
					<div class="grid grid-cols-2 gap-4">
						<div>
							...
							<input wire:model ="firstName" class="w-full rounded-lg border py-2 px-3 dark:bg-gray-700 dark:text-white dark:border-none @error('firstName') border-red-500 @enderror" id="first_name" type="text">
							</input>
							@error('firstName')
						...
						<div>
							...
							<input wire:model ="lastName" class="w-full rounded-lg border py-2 px-3 dark:bg-gray-700 dark:text-white dark:border-none @error('lastName') border-red-500 @enderror " id="last_name" type="text">
							</input>
							@error('lastName')
							<div class="text-red-500 text-sm">
                             {{$message}}
					...
					<div class="mt-4">
						...
						<input wire:model ="streetAddress" class="w-full rounded-lg border py-2 px-3 dark:bg-gray-700 dark:text-white dark:border-none @error('streetAddress') border-red-500 @enderror " id="address" type="text">
						</input>
						@error('streetAddress')
							<div class="text-red-500 text-sm">
                             {{$message}}
					...
					<div class="grid grid-cols-2 gap-4 mt-4">
						...
						<div>
							...
							<input wire:model ="zipCode" class="w-full rounded-lg border py-2 px-3 dark:bg-gray-700 dark:text-white dark:border-none @error('zipCode') border-red-500 @enderror " id="zip" type="text">
							</input>
							@error('zipCode')
							<div class="text-red-500 text-sm">
                             {{$message}}
				...
				<ul class="grid w-full gap-6 md:grid-cols-2">
					<li>
						<input wire:model ="paymentMethod" class="hidden peer" id="hosting-small" type="radio" value="cod" />
